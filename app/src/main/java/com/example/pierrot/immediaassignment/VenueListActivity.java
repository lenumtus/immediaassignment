...
public class VenueListActivity extends ActionBarActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragment = (VenueListFragment)getFragmentManager().findFragmentById(R.id.venue_list);
    ...
    public void onLocationChanged(Location newLocation) {
        ...
        if (newLocation != null && !this.isFinishing()) {
            ...
            if (mLastUpdateLocation == null ||
                ...
                new LoadVenues(mFragment).execute(locationString);
            }
        }
    }
    ...
    private class GoogleApiHandler implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
        ...
        public void onConnectionFailed(ConnectionResult connectionResult) {
            ...
            Toast.makeText(VenueListActivity.this, "Unable to connect to Google for location services, sorry.", Toast.LENGTH_SHORT).show();
        }
    }
}
